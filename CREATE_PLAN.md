Based on everything we discussed, create a detailed implementation plan in PLAN.md with the
following structure:
...
- Prefix tasks requiring manual/human action with [MANUAL] (device testing, UI verification,
  external service setup)
- Check for existing tests related to the code being changed; include tasks to update existing tests
