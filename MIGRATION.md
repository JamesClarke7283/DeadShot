...
| Rendering | Three-step toon lighting, outline, atmosphere, shadows, screen effects | Source lighting/color/fog, VFX and shadow pass verified; six paired map views retained; aerial mean RGB error below 0.22/255 and player views below 1.41/255; screen-effect fixtures below 0.55/255 |
